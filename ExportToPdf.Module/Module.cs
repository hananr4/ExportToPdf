...
using ExportToPdf.Module.Reports;
using ExportToPdf.Module.BusinessObjects;

namespace ExportToPdf.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class ExportToPdfModule : ModuleBase {
    public ExportToPdfModule() {
		// 
		// ExportToPdfModule
		// 
    ...
    public override IEnumerable<ModuleUpdater> GetModuleUpdaters(IObjectSpace objectSpace, Version versionFromDB) {
        ...
        predefinedReportsUpdater.AddPredefinedReport<CustomerReport>("Customer Report", typeof(Customer));
